...
\begin{abstract}
This paper outlines a project proposal to hardware accelerate the generation of a chain of large prime numbers, known as a Cunningham chain, on an FPGA. The motivation for this project came from a cryptocurrency called Primecoin, specifically its proof-of-work. Primecoin accepts as a proof-of-work a Cunningham chain of the first or second kind, as well as a Bi-twin chain. Due to this proof-of-work, there have been little public success with hardware acceleration of the mining of this cryptocurrency, providing proof that such a problem is not an easy one to attempt.\\
